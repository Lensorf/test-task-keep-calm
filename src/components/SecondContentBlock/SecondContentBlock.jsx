    ...
    <div className="MainBlock">
      ...
      <div className="firstMainBlock">
        <div className="FirstBlockComponent">
          <img className="LeftImage" src="2julia-d-FlNTu2Bj4Dg-unsplash.png" alt="foto" />
        ...
        <div className="SecondBlockComponent">
          ...
          <img className="RigthImage" src="2taisiia-stupak-viq7xx1boxo-unsplash 1.png" alt="foto" />
        </div>
      </div>
    </div>
  );
